...
const ContactosDropdown = ({ isMobile, isContactosOpen }) => {
  ...
  return (
    <ul
      ...
      className={`contactos-dropdown flex flex-col absolute ${isMobile ? 'left-[-56vw]' : 'left-[-6vw]'} bg-secondary/90 gap-2 -z-10`}
    >
      <li>
        <img src={pin} alt="location icon" className="contactos-icon" />
        <p className="contact-text font-helveticaNeue font-light">Av. Galo Plaza Lasso N53 208 y Los Pinos</p>
      </li>
      <li>
        <img src={phone} alt="telephone icon" className="contactos-icon" />
        <p className="contact-text font-helveticaNeue font-light">0999441305 - 0985722115 - 02240047</p>
      </li>
      <li>
