...
const Footer = () => (
  <>
    <div className="footer-top h-12 flex justify-between">
      ...
      <div className="footer-actions flex h-full items-center gap-1">
        <p className="footer-actions-word text-xs font-helveticaNeue font-light text-secondary">Inicio</p>
